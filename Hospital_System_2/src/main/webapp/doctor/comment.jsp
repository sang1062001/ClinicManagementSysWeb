...
<head>
<meta charset="UTF-8">
<title>Bình luận bệnh nhân</title>
		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-4">Bình luận bệnh nhân</p>
						...
						<form class="row" action="../updateStatus" method="post">
							...
							<div class="col-md-6">
								<br> <label>Bệnh tình</label> <input type="text" readonly
							...
							<button class=" mt-3 btn btn-primary col-md-6 offset-md-3">Xác nhận</button>
