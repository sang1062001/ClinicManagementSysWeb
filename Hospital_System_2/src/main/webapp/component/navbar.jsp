    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <c:if test="${empty userObj }">
        	<li class="nav-item"><a class="nav-link active" 
          	...
          	<li class="nav-item"><a class="nav-link active" 
          	aria-current="page" href="doctor_login.jsp">BÁC SĨ</a>
          	
          	</li>
<!--           	<li class="nav-item"><a class="nav-link active" 
          	aria-current="page" href="user_appointment.jsp">CUỘC HẸN</a>
          	
          	</li> -->
          	<li class="nav-item"><a class="nav-link active" 
          	aria-current="page" href="user_login.jsp">NGƯỜI DÙNG</a>
			...
			<c:if test="${not empty userObj }">
				<li class="nav-item"><a class="nav-link active" 
          			aria-current="page" href="user_appointment.jsp">CUỘC HẸN</a></li>
 
 				<li class="nav-item"><a class="nav-link active" 
          			aria-current="page" href="view_appointment.jsp">XEM CUỘC HẸN</a></li>    
